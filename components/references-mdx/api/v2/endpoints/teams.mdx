...
| **confirmed**         | <HelpLink href="#api-basics/types">Boolean</HelpLink>      | Value is `true` if the member was accepted or joined the team. |
...
<Note>
  Users who requested access cannot be invited and must instead be accepted.
...
| **confirmed** | <HelpLink href="#api-basics/types">Boolean</HelpLink>      | No       | Accept a user that requested access to the team.                  |
...
<Note>
  ...
  <Link href="/docs/v2/platform/frequently-asked-questions#maximum-team-member-requests">
    Read the FAQ.
  </Link>
</Note>
