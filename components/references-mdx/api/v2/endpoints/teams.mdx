...
| **confirmed**         | <HelpLink href="#api-basics/types">Boolean</HelpLink>      | Value is `true` when the member was accepted or joined the team. |
...
Invite a user to join the team specified in the URL. To use it, send a `POST` request with the user's email address in the body.
